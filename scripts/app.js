...
// }
    ...
    // // console.log(row)
    // row.forEach(number => {
    //   //if the length of the row set is 10 remove fixed but if the square above
    //   //is fixed make fixed again.
    //
    //
    //   if(row.length === 10) {
    ...
    //       row.push(number)
    //       squares[number].classList.add('fixed')
    //     }
    //   }
    //   // if (row.length === 10 && squares[number-10].className !== 'grid-item fixed'){
    //   //   squares[number].classList.remove('fixed')
    //   //
    //   //   //if the set is 10 and the square above is already fixed
    //   // } else if (row.length === 10 && squares[number-10].className === 'grid-item fixed'){
    //   //   squares[number-10].classList.remove('fixed')
    //   //
    //   // }
